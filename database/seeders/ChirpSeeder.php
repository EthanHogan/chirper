...
class ChirpSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('chirps')->insert([
            ...
            'chirp' => "We went rock climbing this weekend? Here is the video. Climbing is way more fun than exercising on any gym equipment. It works both your mind and body. Best of all it trains you to be creative and think out of the box. It's also an ongoing competition with yourself as you aim to improve your performance. ENJOY!",
        ...
        DB::table('chirps')->insert([
            ...
            'chirp' => "Do you wanna learn Javascript? I'm gonna make a Udemy tutorial to show you all how easy it is.",
            'file' => '/pics/Code.png',
            'is_video' => false,
            'comments' => '83',
            'rechirps' => '59',
        ...
        DB::table('chirps')->insert([
            ...
            'chirp' => "Just made a new SEO marketing video. Take a look!!! The good news is that there are several search engine optimization (SEO) tools out there — some free, some paid — that can help you view",
            'file' => '/videos/Seo.mp4',
            'is_video' => true,
            'comments' => '56',
            'rechirps' => '54',
